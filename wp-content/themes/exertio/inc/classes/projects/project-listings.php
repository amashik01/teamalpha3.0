                  ...
                  <div class="fr-right-detail-content">
                    <div class="fr-right-details-products">
                      ...
                      <div class="fr-right-views">
                        <ul>
                          <li><span><?php echo $profile_clickable; ?><?php echo exertio_get_username( 'employer', $employer_id, 'badge' ); echo $profile_clickable_close;?></span> </li>
                        </ul>
                      </div>
                  ...
                  <div class="fr-right-information">
                    ...
                    <div class="fr-right-bid">
                      <ul>
                        ...
                        <li><a href="<?php echo esc_url(get_the_permalink()); ?>" class="btn btn-theme"><?php echo esc_html__( ' Collaborate ', 'exertio_theme' ); ?></a></li>
                      </ul>
                    </div>
                  </div>
                </div>
		...
		function exertio_projects_list_2($project_id, $cols = '') 
		{
            ...
            <div class="<?php echo esc_attr($col_size); ?>">
            	<div class="project-list-2">
                	<div class="top-side">
                    	<span class="user-name"> <?php echo $profile_clickable; ?><?php echo exertio_get_username('employer', $employer_id, 'badge'); ?><?php echo $profile_clickable_close;?></span>
                    ...
                    <div class="bottom-side">
                        ...
                        <?php
							...
							$project_seeker_typel = get_term_names('project-seeker-type', '_project_project_seeker_type', $project_id );
						?>
                            ...
                            <li><i class="far fa-id-badge"></i> <?php echo esc_html($project_seeker_typel); ?></li>
                        </ul>
                    ...
                    <div class="res-us-inline">
                      <ul>
                      	<?php
                        	$project_duration = get_term_names('project-duration', '_project_duration', $project_id );
							$project_level =  get_term_names('project-level', '_project_level', $project_id );
							$project_seeker_type = get_term_names('project-seeker-type', '_project_project_seeker_type', $project_id );
						?>
                        ...
                        <li><span><i class="far fa-user"></i> <?php echo esc_html($project_seeker_type); ?></span></li>
                        <li><span><i class="far fa-calendar-alt"></i> <?php echo project_expiry_calculation($project_id); ?></span></li>
                        <li class="fr1-top-content">
                        	<?php
								$marked_fav = $fav  = '';
								$fav_text = esc_html__('Save Project','exertio_theme');
                            ...
                            <p><a href="<?php echo esc_url(get_the_permalink()); ?>" class="btn btn-theme"><?php echo esc_html__( 'view project', 'exertio_theme' ); ?></a></p>
                        </li>
                      </ul>
                    </div>
                    <?php
