								...
								<div class="form-group col-md-12">
								  ...
								  $saved_skills = wp_get_post_terms($pid, 'skills', array( 'fields' => 'all' ));
									if ( !empty($skills_taxonomies) )
									{
										...
										$skill .= '<option value="" disabled> '. __( "Select required skills", "exertio_theme" ) .'</option>';
							...
							<script>
							  ...
							  <div class="form-row">
								<div class="form-group col-md-6">
								  ...
								  <input type="text" class="form-control" name="project_lat" id="loc_lat" value="<?php echo get_post_meta($pid, '_project_latitude', true); ?>">
								</div>
								<div class="form-group col-md-6">
								  <label><?php echo esc_html__('Longitude','exertio_theme'); ?></label>
								  <input type="text" class="form-control" name="project_long" id="loc_long" value="<?php echo get_post_meta($pid, '_project_longitude', true); ?>">
								</div>
							  </div>
							</div>
						  </div>
