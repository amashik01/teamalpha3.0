							  ...
							  <div class="pro-box">
								<div class="pro-coulmn pro-title">
									...
									<span class="pro-btns">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-inverse-primary btn-sm bump_up_project" data-pid="<?php echo esc_attr($pid); ?>" data-status="bump_up"> <i class="text-info far fa-edit"></i> <?php echo esc_html__( 'Bump up', 'exertio_theme' ); ?></a>
