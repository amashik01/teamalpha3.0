        ...
        <div class="row">
            <div class="col-12">
                <div class="chat-description">
                  <h3><?php  echo __('Please install Sb chat plugin to enable chat feature','exertio_theme');  ?></h3>
            </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="modal-content">
                                <div class="chat-header">
                                    ...
                                    <div class="msg-search">
                                        <input type="text" class="form-control" id="inlineFormInputGroup" placeholder="<?php echo esc_attr__('Search','exertio_theme')?>" aria-label="search">
                                    </div>
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="Open-tab" data-bs-toggle="tab" data-bs-target="#Open" type="button" role="tab" aria-controls="Open" aria-selected="true"><?php echo esc_html__('All Conversations','exertio_theme')?></button>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="modal-content"><?php
                                ...
                                if ( ! $current_conversation ) { ?>
                                    ...
                                    <div class="send-box chat-footer">
                                        <h4 class="not-found"><?php esc_html_e('No Message found.','exertio_theme'); ?></h4>
                                    </div><?php
                                }
                                ...
                                if ( $user_id == $user_1 || $user_id == $user_2 ) {
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <ul class="moreoption">
                                                    ...
                                                    <button class="delete-single-chat btn-theme" data-delete="<?php echo esc_attr__( 'Are you sure you want to remove this?', 'exertio_theme' ); ?>" href="#"><?php echo esc_html__('Delete','exertio_theme')  ?></button>    
                                                        <div class="sb-notification success"><p><?php esc_html_e( 'Conversation is removed', 'exertio_theme' ); ?></p></div>
                                    ...
                                    <div class="send-box chat-footer">
                                        ...
                                        <form action="" class="send-message" enctype="multipart/form-data">
                                            <div class="d-flex">
                                                <input type="text" id="message_box" class="form-control message-details" aria-label="message…" placeholder="<?php echo esc_attr__('Write message…','exertio_theme');?>">
                                                <button class="btn btn-theme btn-icon send-btn text-light mb-1" type="submit"><i class="fa fa-paper-plane" aria-hidden="true"></i><?php echo esc_html__('Send','exertio_theme')?></button>
                                            ...
                                            <div id="sbchat-mu" class="sbchat_upload_items"><?php
                                                ...
                                                echo esc_html__('Add attachments','exertio_theme');
