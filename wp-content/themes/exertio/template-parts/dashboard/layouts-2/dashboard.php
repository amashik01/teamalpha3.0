			...
			<div class="row">		
				...
				<div class="col-md-6 col-lg-6 col-xl-3">
					<div class="info-boxes">
						...
						<p class="matric-bottom"> <a href="<?php echo esc_url(get_the_permalink());?>?ext=my-ratings"><?php echo esc_html__('View Detail', 'exertio_theme' ); ?> <i class="fas fa-arrow-right"></i></a></p>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="card-body">
				  <h4 class="card-title"><?php echo esc_html__('Current Plan Detail', 'exertio_theme' ); ?></h4>
					...
					<?php
                        ...
                        $freelancer_listing_bump = get_post_meta($freelancer_id, '_freelancer_listing_bump', true);

                        $freelancer_listing_bump = isset( $freelancer_listing_bump) && $freelancer_listing_bump == -1 ? esc_html__(' Unlimited ', 'exertio_theme' ) : $freelancer_listing_bump;
					...
					if(isset($simple_services) && $simple_services != '' && $freelancer_package_expiry_date != '')
					{
						...
						?>
							<ul>
								...
								<li><i class="far fa-check-square"></i> <?php echo '<span>'.esc_html__('Bump Up Services: ', 'exertio_theme' ).'</span>'.esc_html($freelancer_listing_bump); ?> </li>
