        ...
        <div class="card-body">
          <div class="pro-section">
				  ...
				  <div class="pro-coulmn pro-title">
					<h4 class="pro-name">
						<a href="<?php  echo esc_url(get_permalink($pid)); ?>"><?php echo esc_html(get_the_title($pid)); ?></a>
							...
							<?php if(isset($result->is_top) && $result->is_top == 1){ ?>
							...
							<?php } ?>
							<?php if(isset($result->is_sealed) && $result->is_sealed == 1){ ?>
            ...
            <?php  } ?>
              ...
              <?php if($result->offer_Status != "3" && $result->offer_Status != "4"  && $result->offer_Status != "2"){ ?>
