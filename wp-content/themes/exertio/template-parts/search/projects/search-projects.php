...
/* Is job alerts */
$job_alerts = ( isset($exertio_theme_options['job_alerts_switch']) && $exertio_theme_options['job_alerts_switch'] != "" ) ? $exertio_theme_options['job_alerts_switch'] : false;
/* Job alert title */
$job_alerts_title = ( isset($exertio_theme_options['job_alerts_title']) && $exertio_theme_options['job_alerts_title'] != "" ) ? $exertio_theme_options['job_alerts_title'] : '';
/* Job alert tagline */
$job_alerts_tagline = ( isset($exertio_theme_options['job_alerts_tagline']) && $exertio_theme_options['job_alerts_tagline'] != "" ) ? $exertio_theme_options['job_alerts_tagline'] : '';
/* Job alert btn */
$job_alerts_btn = ( isset($exertio_theme_options['job_alerts_btn']) && $exertio_theme_options['job_alerts_btn'] != "" ) ? $exertio_theme_options['job_alerts_btn'] : '';
?>
