        ...
        <div class="container-scroller">
            <div class="container-fluid page-body-wrapper">
              ...
              <div class="main-panel">
				<?php
				if(fl_framework_get_options('fl_allow_user_email_verification') != null && fl_framework_get_options('fl_allow_user_email_verification') == true)
				{
                 ...
                 $announcement_mesg  =  fl_framework_get_options('announcement_mesg');
                if(fl_framework_get_options('show_announcement') &&  $announcement_mesg  != ""){
				?>
                 ...
                 <div class="exertio-alert alert alert-danger alert-dismissible fade show" role="alert">
							<div class="exertio-alart-box">
								...
								<div class="text-info">
									<h5><?php echo  fl_framework_get_options('announcement_title'); ?> </h5>
									<p>
										<?php echo wp_return_echo($announcement_mesg); ?>
									</p>
									</div>
								<button type="button" class="close" data-dismiss="alert" aria-label="Close">
									<span aria-hidden="true">&times;</span>
