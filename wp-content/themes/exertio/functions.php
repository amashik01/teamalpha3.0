...
function replace_freelancer_with_project_seeker($content) {
    $content = str_replace('Freelancer', 'Project Seeker', $content);
    return $content;
}

add_filter('the_content', 'replace_freelancer_with_project_seeker');
add_filter('widget_text_content', 'replace_freelancer_with_project_seeker');
