			...
			<div class="row">
			  ...
			  <div class="col-xl-4 col-lg-5 col-md-5 col-sm-5 align-self-center">
				<div class="fr-expert-content">
					<?php if( get_user_meta( get_current_user_id(), '_emp_follow_id_'.$emp_id, true ) == $emp_id ) { ?>
		  ...
		  <div class="col-lg-4 col-xl-4 col-md-12 col-xs-12 col-sm-12">
			<div class="fr-c-details">
			  ...
			  <div class="fr-ca-more-details">
				...
				?>
                <?php
                if(isset($exertio_theme_options['employer_department']) && $exertio_theme_options['employer_department'] == 3){
                }
                else {
                    ?>
				  <li>
                ...
                <?php } ?>
                    <?php
                    if(isset($exertio_theme_options['employer_employee_count']) && $exertio_theme_options['employer_employee_count'] == 3){
                    }
                    else {
                        ?>
				        <li>
				  ...
				  <li>
                    ...
                    <?php if (intval(get_post_meta($emp_id, 'exertio_employer_total_views', true) != "")) { ?>
                <li>
                    <div class="fr-c-full-details"> <span><?php echo esc_html__('Total Views','exertio_theme'); ?></span>
                        <p><i class="far fa-eye" style="margin-right: 5px;"></i><?php echo wp_sprintf(esc_html__('%s Views', 'exertio_theme'), number_format(get_post_meta($emp_id, 'exertio_employer_total_views', true)));?></p>
                    </div>
                </li>
                <?php } ?>
				</ul>
									 ...
									 <div class="style-hd">
									  ...
									  <?php
										...
										if($project_type == 'hourly' || $project_type == 2)
										{
											...
											echo '<p class="price_type protip" data-pt-title="'.esc_attr__('For ','exertio_theme').$hours.__(' hours total will be  ','exertio_theme'). fl_price_separator(intval($hours)*intval($price)).'" data-pt-position="top" data-pt-scheme="black">'.$project_type_text.' <i class="far fa-question-circle"></i></p>';
										}
